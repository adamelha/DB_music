...
gulp.task('html', ['inject', 'partials'], function () {
    ...
    var appFilter = $.filter('**/app-*.js', { restore: true, dot:true});
    var assets;
...
gulp.task('html:prod',  function () {
    var partialsInjectFile = gulp.src(path.join(conf.paths.src, '/partials/templateCacheHtml.js'), { read: false });
    var partialsInjectOptions = {
        starttag: '<!-- inject:partials -->',
        ignorePath: path.join(conf.paths.src, '/partials'),
        addRootSlash: false
    };
