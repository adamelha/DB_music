...
(function () {
  ...
  angular.module('BlurAdmin.pages', ['ui.router', 'BlurAdmin.pages.dashboard', 'BlurAdmin.pages.ui', 'BlurAdmin.pages.components', 'BlurAdmin.pages.form', 'BlurAdmin.pages.tables', 'BlurAdmin.pages.charts', 'BlurAdmin.pages.maps', 'BlurAdmin.pages.profile', 'BlurAdmin.pages.songs', 'BlurAdmin.pages.artists']).config(routeConfig);
...
angular.module('BlurAdmin', ['ngAnimate', 'ui.bootstrap', 'ui.sortable', 'ui.router', 'ngTouch', 'toastr', 'Alertify', 'smart-table', "xeditable", 'ui.slimscroll', 'ngJsTree', 'angular-progress-button-styles', 'BlurAdmin.connection', 'BlurAdmin.theme', 'BlurAdmin.auth', 'BlurAdmin.pages']);
(function () {
  'use strict';

  angular.module('BlurAdmin.auth').controller('loginPageCtrl', ['$scope', 'editableOptions', 'editableThemes', 'ServerConnection', '$state', 'Alertify', function ($scope, editableOptions, editableThemes, ServerConnection, $state, Alertify) {
    ...
    function getUserAndPassInput() {
      return {
        name: angular.element('#inputEmail3').val(),
    ...
    return {
      ...
      controller: ["$scope", "$transclude", "editableOptions", "editableThemes", "$timeout", "ServerConnection", "$q", function controller($scope, $transclude, editableOptions, editableThemes, $timeout, ServerConnection, $q) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return _context2.abrupt('return', d.promise);
        ...
        $scope.getDataFromServer = function () {
          var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tableCtrl, a, field) {
            var paging, sort, filters, populate, reqOtions, reqResult, items, itemCount;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    paging = getPagination(tableCtrl.pagination);
                    sort = getSort(tableCtrl.sort);
                    filters = Object.assign({}, $scope.tableConfig.options.filter, tableCtrl.filter);
                    populate = $scope.tableConfig.options.populate;
                    reqOtions = { filters: filters, paging: paging, sort: sort, populate: populate
                      //
                    };
                    reqResult = void 0;
                  ...
                  case 14:
                    reqResult = _context.sent;
                    _context.next = 20;
                    break;

                  case 17:
                    _context.next = 19;
                    return ServerConnection.get($scope.tableConfig.path, reqOtions);
                  ...
                  case 20:
                    //
                    items = reqResult.results;
                    itemCount = reqResult.total_rows;
                    //
                    ...
                    return _context.abrupt('return', $scope.tableState.items);
...
(function () {
  ...
  songsCtrl.$inject = ["$scope", "$filter", "editableOptions", "editableThemes"];
  angular.module('BlurAdmin.pages.songs').controller('songsCtrl', songsCtrl);

  /** @ngInject */
  function songsCtrl($scope, $filter, editableOptions, editableThemes) {
...
//# sourceMappingURL=../maps/scripts/app-d30dbf405c.js.map
