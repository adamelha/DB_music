...
class Musixmatch(object):
    ...
    def __init__(self, apikey = apikey_musixmatch, url = apiurl_musixmatch):
    ...
    def chart_artists(self, page, page_size, country='us', _format='json'):
        ...
        data = self._request(self._get_url('chart.artists.get?'
                                           'page={}&page_size={}'
                                           '&country={}&format={}'
                                           .format(page,_set_page_size(page_size),country, _format)))
        return data
    ...
    def artist_albums_get(self, artist_id, g_album_name, page, page_size,
                          s_release_date='desc', artist_mbid=None, _format='json'):
    ...
    def album_tracks_get(self, album_id, page, page_size,
        ...
        data = self._request(self._get_url('album.tracks.get?album_id={}'
                                           ...
                                           '&format={}'
                                           .format(album_id,f_has_lyrics, page,
                                                   _set_page_size(page_size),
                                                   _format)))
        return data
...
def main():
 ...
 #   print (track_id)
    ...
    jsonobj = musixmatch.chart_artists(1, 1)
    #or key in jsonobj:
    #    print(key + " corresponds to " + jsonob )#+ jsonobj[key])
    print (jsonobj["message"]["body"]["artist_list"][0]["artist"]["artist_name"])
